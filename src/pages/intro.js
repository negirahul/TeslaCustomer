      ...
      <Splide className="my-carousel" aria-label="Main text slider" options={{
            ...
            <SplideSlide>
              <div className="slider-text-2">
                <div className="text-center">
                  <img src={require('../img/warranty-png.png')} alt="" />
                  <h2>REGISTER<br/>WARRANTY</h2>
                  <p>Earn handsome reward points for future purchase </p>
                </div>
              </div>
            </SplideSlide>
            <SplideSlide>
            ...
            <SplideSlide>
              <div className="slider-text-2">
                <div className="text-center">
                  <img src={require('../img/Gringo-Pro-3.png')} alt="" />
                  <h2>EASY<br/>CLAIMS</h2>
                  <p>Submit a quick warranty claim for doorstep services</p>
                </div>
              </div>
            </SplideSlide>
          </Splide>
      </div>
    <Link className="nav-Link open-link btn-black text-center" to={'/login'}>START AS CUSTOMER <ArrowRight /></Link>
      </div>
    </div>
  );
}
